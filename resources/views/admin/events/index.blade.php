                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="td-actions text-right">
                                                <button type="button" data-placement="top" title
                                                    data-original-title="View Details"
                                                    class="btn btn-info btn-link btn-sm" data-toggle="modal"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <div class="left-side">
                        <button class="btn btn-warning btn-link">Edit Event</button>
                    </div>
